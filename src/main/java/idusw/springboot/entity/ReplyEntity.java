...
public class ReplyEntity extends BaseEntity {
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "a201812012_reply_seq_gen")
    @SequenceGenerator(sequenceName = "a201812012_reply_seq", name = "a201812012_reply_seq_gen", initialValue = 1, allocationSize = 1)
